...
> **Objectif** : Exécuter tous les SQL nécessaires pour le projet GirlyCrea
...
1. **Ouvrir Supabase Dashboard**
   ...
   - Sélectionner le projet GirlyCrea
...
3. **Copier le script complet**
   ```bash
   cat girlycrea-site/backend/scripts/sql-complet-supabase.sql
   ```
...
**Fichier** : `girlycrea-docs/03-prompts/_nouvelle-structure/archive/anciens-fichiers/j2-backend-core/sql/refresh-tokens.sql`
...
**Fichier** : `girlycrea-docs/03-prompts/_nouvelle-structure/archive/anciens-fichiers/j2-backend-core/sql/products-fulltext.sql`
...
**Fichier** : `girlycrea-docs/03-prompts/_nouvelle-structure/archive/anciens-fichiers/j2-backend-core/sql/rls-policies.sql`
...
**Fichiers** : `girlycrea-docs/03-prompts/_nouvelle-structure/perplexity/sql/j3/*.sql`
