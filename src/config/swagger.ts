...
const swaggerDefinition = {
  ...
  info: {
    title: 'GirlyCrea API',
    version: '1.0.0',
    description: 'Documentation complète de l\'API GirlyCrea - E-commerce backend avec gestion produits, commandes, utilisateurs, métriques et plus.',
    contact: {
      name: 'GirlyCrea Support',
    },
    license: {
      name: 'ISC',
    },
